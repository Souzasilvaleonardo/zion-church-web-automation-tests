...
Cypress.Commands.add('editFamilyMembers', () => {
  ...
  cy.get('div[class="font-medium"]')
    .contains('Caio Almeida Silva')
    .click()
  ...
  cy.get('button[data-testid="profile-family-information-remove-be17f6ee-abcb-4fd1-9eba-66c4833bafe8"]').click()
})
